...
function buildHead(): Buffer {
  ...
  let o = 0;
  sidx.writeUInt32BE(sidxSize, o);
  o += 4;
  sidx.write("sidx", o, "latin1");
  o += 4;
  sidx.writeUInt8(0, o);
  o += 1; // version 0
  o += 3; // flags
  sidx.writeUInt32BE(1, o);
  o += 4; // reference_ID
  sidx.writeUInt32BE(1000, o);
  o += 4; // timescale
  sidx.writeUInt32BE(0, o);
  o += 4; // earliest_presentation_time
  sidx.writeUInt32BE(0, o);
  o += 4; // first_offset
  o += 2; // reserved
  sidx.writeUInt16BE(segs.length, o);
  o += 2; // reference_count
  for (const s of segs) {
    sidx.writeUInt32BE(s.size & 0x7fffffff, o);
    o += 4; // reference_type=0 | size
    sidx.writeUInt32BE(s.dur, o);
    o += 4;
    sidx.writeUInt32BE(0, o);
    o += 4; // SAP
  }
