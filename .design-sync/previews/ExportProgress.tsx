...
import * as S from "@ds-stories/src/features/export/components/ExportProgress.stories";
...
export const FileSource = compose(S, "FileSource");
export const UrlSource = compose(S, "UrlSource");
export const Starting = compose(S, "Starting");
export const AlmostDone = compose(S, "AlmostDone");
