...
import * as S from "@ds-stories/src/features/timeline/components/WaveformBackground.stories";
...
export const WithVideoFile = compose(S, "WithVideoFile");
export const NoVideoFile = compose(S, "NoVideoFile");
