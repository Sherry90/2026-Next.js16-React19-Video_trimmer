...
import * as S from "@ds-stories/src/features/export/components/ErrorDisplay.stories";
...
export const ProcessingFailed = compose(S, "ProcessingFailed");
export const MemoryInsufficient = compose(S, "MemoryInsufficient");
export const Unknown = compose(S, "Unknown");
export const ViaStore = compose(S, "ViaStore");
