...
import * as S from "@ds-stories/src/features/timeline/components/TrimHandle.stories";
...
export const InPoint = compose(S, "InPoint");
export const OutPoint = compose(S, "OutPoint");
export const InPointLocked = compose(S, "InPointLocked");
