...
import * as S from "@ds-stories/src/features/player/components/PlayerControlBar.stories";
...
export const Playing = compose(S, "Playing");
export const Muted = compose(S, "Muted");
