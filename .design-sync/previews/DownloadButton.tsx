...
import * as S from "@ds-stories/src/features/export/components/DownloadButton.stories";
...
export const NoExtension = compose(S, "NoExtension");
export const LongFilename = compose(S, "LongFilename");
